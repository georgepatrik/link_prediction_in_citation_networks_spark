...
trainingRDD = sc.textFile("/Users/georgepatrick/pyspark_projects/training_set.txt")
...
infoRDD = sc.textFile("/Users/georgepatrick/pyspark_projects/node_information.csv")
